...
export default function Navbar() {
    ...
    return (
        <header className="relative h-16 border-b border-zinc-800 bg-inherit">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative w-96">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-border bg-surface py-2 pl-10 pr-4 text-white outline-none transition focus:border-blue-500"
                        />
